...
namespace SunfounderSensorKit.ViewModels
{
    public class RgbLed02 : ViewModelBase
    {
        ...
        private readonly int[] colors = {0xFF0000, 0x00FF00, 0x0000FF, 0xFFFF00, 0xFF00FF, 0x00FFFF, 0xFF6600, 0x5EFFD1, 0x000000 };
        ...
        private void SetColor(int color)
        {
            ...
            foreach (KeyValuePair<string, int> pin in pins)
            {
                ...
                activeDutyCycle = 1 - double.Parse($"0.{activeDutyCycle}");
